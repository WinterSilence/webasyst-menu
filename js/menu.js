        ...
        bindEvents: function () {
            ...
            $('#wa-app').on('click', '[data-menu-edit]', function (e) {
                ...
                $.get('?module=menu&action=add&id='+id, function (r) {
                    $(r).waDialog({
                        'buttons': '<input class="button green" type="submit" value="'+$.wa.locale['Save']+'" />' +
                            ' '+$.wa.locale['or']+' ' +
            ...
            $content.on('click', '[data-menu-delete]', function (e) {
                e.preventDefault();
                var $t = $(this),
                    id = $t.closest('[data-menu-id]').data('menu-id');
                ...
                if(confirm($.wa.locale['This will permanently delete menu and all its items without the ability to recover. Are you sure?'])) {
                    $t.removeClass('delete').addClass('loading');
